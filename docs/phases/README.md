...
| **P7 Hardening + stores** | 20–22 | [P7-hardening-stores.md](P7-hardening-stores.md) | App Store + Play submissions accepted |
...
- **Migration slots:** phase P*n* owns `supabase/migrations/000000000000<n>0`–`<n>9_*.sql` (P0 owns `…00`–`…09` and uses `…02`/`…03` for hardening); `00000000000001_core.sql` is the existing schema ground truth.
