 ...
 */
function TypeChip({ type = "discover", style = "solid", size = "md", custom, css = {} }) {
 ...
 */
function Badge({ children, tone = "neutral", icon = null, solid = false, css = {} }) {
 ...
 */
function RatingStars({ value = 0, max = 5, size = 16, count = null, showValue = false, onRate = null, css = {} }) {
  const Star = ({ fill, idx }) => (
    <span
 ...
 */
function StatBlock({ value, label, unit = "", accent = "var(--ink-900)", align = "center", size = "md", css = {} }) {
...
/* ===== components/run/MapPin.jsx ===== */

const TYPE_COLOR_m10 = {
...
function MapPin({
  ...
  const color = TYPE_COLOR_m10[type] || TYPE_COLOR_m10.discover;
...
/* ===== components/run/RouteMarker.jsx ===== */
 ...
 */
function RouteMarker({ kind = "start", type = "discover", size = 28, css = {} }) {
  const TYPE_COLOR_m11 = { discover: "var(--discover)", challenge: "var(--challenge)", social: "var(--social)" };
  const color = TYPE_COLOR_m11[type] || TYPE_COLOR_m11.discover;
...
function RunCard({
  ...
  const accent = TYPE_COLOR_m12[type] || TYPE_COLOR_m12.discover;
 ...
 */
function PhoneFrame({ children, dark = false, time = "7:24" }) {
  return (
    <div style={{
...
function ExploreScreen({ onOpenRun = () => {}, onOpenFilters = () => {} }) {
...
/* ===== ui_kits/mobile/RunDetailScreen.jsx ===== */
...
function RunDetailScreen({ onBack = () => {}, onJoin = () => {} }) {
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", background: "var(--paper-2)" }}>
      <div style={{ flex: 1, overflowY: "auto", paddingBottom: 110 }}>
        ...
        <div style={{ padding: "18px 20px 0", marginTop: -4 }}>
          ...
          <h1 style={{ margin: 0, fontFamily: "var(--font-display)", fontWeight: 900, fontSize: 32, lineHeight: 1,
...
function ProfileScreen({ onEdit = () => {}, self = true }) {
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", background: "var(--paper-2)" }}>
      <div style={{ flex: 1, overflowY: "auto", paddingBottom: 96 }}>
        ...
        <div style={{ background: "var(--ink-900)", padding: "58px 20px 26px", position: "relative" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <h1 style={{ margin: 0, fontFamily: "var(--font-display)", fontWeight: 900, fontSize: 28, textTransform: "uppercase", color: "#fff", lineHeight: 1 }}>Maya Okafor</h1>
              </div>
          ...
          <p style={{ margin: "16px 0 0", color: "var(--ink-300)", fontSize: 14, lineHeight: 1.5, fontWeight: 400 }}>
            Marathoner, map-collector. Home base Lisbon 🇵🇹 — happy to show visitors the hilly bits. EN / PT / FR.
          </p>
 ...
 global.RE = { Button, IconButton, Input, Tabs, TabBar, TypeChip, Badge, Avatar, RatingStars, StatBlock, MapPin, RouteMarker, RunCard, PhoneFrame, MapCanvas, ExploreScreen, RunsScreen, RunDetailScreen, ProfileScreen };
})(window);